...
public class SimilarPlacesAdapter extends RecyclerView.Adapter<SimilarPlacesAdapter.ViewHolder> {
    private final Paris.SimilarPlace[] mSimilarPlaces = Paris.similarPlaces;
    @Override
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        Paris.SimilarPlace place = mSimilarPlaces[position];
